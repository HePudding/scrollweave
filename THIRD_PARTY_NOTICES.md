...
`npm run licenses` 检查 package-lock 中 **276** 个含平台可选包的记录；当前 Windows 安装了 **207** 个依赖包。完整机器可读列表见 [docs/dependency-licenses.json](docs/dependency-licenses.json)。更新依赖后数字以重新生成的报告为准。
